...
if awesome.startup_errors then
  logger.log(TAG, "errors during startup: " .. awesome.startup_errors, logger.ERROR)
  naughty.notify({
...
do
    ...
    awesome.connect_signal("debug::error", function (err)
        ...
        in_error = true
        logger.log(TAG, "runtime error: " .. awesome.startup_errors, logger.ERROR)
...
awful.rules.rules = {
    ...
    { rule = { class = "qBittorrent"},
          properties = { tag = screen[2].tags[4] } },
    { rule = { class = "Deluge"},
          properties = { tag = screen[2].tags[4] } },
    { rule = { class = "nulloy"},
          properties = { tag = screen[2].tags[5] } },
    { rule = { class = "factorio*"},
